...
def trace(cfg):
    vocab_size = cfg['trace']['vocab_size']
    vocab_dim = cfg['trace']['vocab_dim']
    hidden_dim = cfg['trace']['hidden_dim']
    n_layers = cfg['trace']['n_layers']
    ffn_dim = cfg['trace']['ffn_dim']
    n_heads = cfg['trace']['n_heads']
    feature_type = cfg['trace']['feature_type']
    compute_type = cfg['trace']['compute_type']
    model = SLiMPerformer(vocab_size, vocab_dim, hidden_dim, n_layers, ffn_dim,
                          n_heads, feature_type, compute_type)
