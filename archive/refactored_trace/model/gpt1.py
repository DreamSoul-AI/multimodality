...
def gpt1(cfg):
    n_head = cfg['gpt1']['n_head']
    n_layer = cfg['gpt1']['n_layer']
    drop_out = cfg['gpt1']['drop_out']
    vocab_size = cfg['gpt1']['vocab_size']
    n_embd = cfg['gpt1']['n_embd']
    block_size = cfg['gpt1']['block_size']
    device = cfg['gpt1']['device']
    model = BigramLanguageModel(n_head, n_layer, drop_out, vocab_size, n_embd, block_size, device)
