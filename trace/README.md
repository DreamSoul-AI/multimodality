...
| Method | Dataset            | Series Length | Inference Time |  BPE training time | Compression Ratio |
| --- |--------------------| --- | --- |--------------------------------------|-------------------|
|TRACE without BPE | dickens (9,954 KB) | 10,192,446 | 835.47 seconds | NA | 4.00              |
|TRACE with BPE | dickens            |  10,192,446 -> 4,696,974 | 1526.15 seconds (including 1133.62 seconds BPE encoding time) | 1117.67 seconds | 4.07              |
